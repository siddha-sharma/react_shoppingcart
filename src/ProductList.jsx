...
function ProductList({ onHomeClick }) {
    ...
    useEffect(() => {
        let totalCount = calculateTotalQuantity(cart);
        setCartItemCount(totalCount);
        
        let filteredProductInCart = getRefreshedProductList();
        setAddedToCart(filteredProductInCart);
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                ...
                                <text x="128" y="150" text-anchor="middle" fill="#faf9f9" font-size="76" font-family="Arial, sans-serif">
                                    {cartItemCount}
                                </text>
                            </svg>
                        </h1></a>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}> 
                                        ...
                                        <button
                                            disabled={(plant.name in addedToCart && addedToCart[plant.name] === true) ? true: false}
